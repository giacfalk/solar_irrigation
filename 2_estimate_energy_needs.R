...
clusters$er_kwh_tt <- ifelse(clusters$npumps==0 | is.infinite(clusters$gr_wat_depth), NA, clusters$er_kwh_tt)
clusters$surface_er_kwh_tt <- ifelse(clusters$npumps==0  | is.infinite(clusters$surfw_dist), NA, clusters$surface_er_kwh_tt)
...
clusters$which_pumping[clusters$gr_wat_depth<=3.5] <- "Surface water pumping"
