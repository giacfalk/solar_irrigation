...
crops = readxl::read_xlsx(paste0("F:/MLED_database/" , 'crops_cfs_ndays_months.xlsx')) %>% dplyr::select(crop, eta_irr)
...
if (scenarios$instalments_business_model[scenario]==F){
...
write_rds(clusters, "clusters_with_data_4.Rds")
